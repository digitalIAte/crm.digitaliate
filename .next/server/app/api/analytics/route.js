"use strict";(()=>{var e={};e.id=567,e.ids=[567],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5900:e=>{e.exports=require("pg")},2951:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>A,patchFetch:()=>y,requestAsyncStorage:()=>d,routeModule:()=>l,serverHooks:()=>p,staticGenerationAsyncStorage:()=>E});var r={};a.r(r),a.d(r,{GET:()=>c});var s=a(9303),o=a(8716),n=a(670),i=a(7070),u=a(5748);async function c(){try{let e=await u.Z.connect();try{let t=await e.query(`
