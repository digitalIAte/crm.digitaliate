"use strict";(()=>{var e={};e.id=567,e.ids=[567],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},35900:e=>{e.exports=require("pg")},22951:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>A,patchFetch:()=>y,requestAsyncStorage:()=>E,routeModule:()=>l,serverHooks:()=>p,staticGenerationAsyncStorage:()=>d});var r={};a.r(r),a.d(r,{GET:()=>c});var s=a(49303),o=a(88716),n=a(60670),i=a(87070);let u=new(a(35900)).Pool({connectionString:process.env.DATABASE_URL,ssl:!process.env.DATABASE_URL?.includes("localhost")&&{rejectUnauthorized:!1}});async function c(){try{let e=await u.connect();try{let t=await e.query(`
