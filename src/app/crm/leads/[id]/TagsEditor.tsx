        ...
        <div className="mt-4 pt-4 border-t border-gray-100">
            ...
            <div className="flex items-center gap-2">
                <input
                    ...
                    className="flex-1 text-sm border-gray-200 rounded-md py-1.5 focus:ring-digitaliate"
                />
                <button onClick={addTag} disabled={isPending || !input.trim()} className="bg-digitaliate text-white px-3 py-1.5 rounded-md text-sm hover:bg-digitaliate-dark disabled:opacity-50">
                    Añadir
                </button>
            </div>
        </div>
