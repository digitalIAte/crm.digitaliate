    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <Link href="/crm/leads" className="text-digitaliate-dark hover:text-digitaliate font-bold flex items-center">&larr; Back to Leads</Link>
            </div>
            ...
            <div className="bg-white shadow-sm rounded-xl p-8 border border-gray-100 flex flex-col md:flex-row justify-between items-start">
                <div className="mb-6 md:mb-0">
                    ...
                    <div className="mt-5 flex items-center space-x-3">
                        <span className="bg-gradient-to-r from-digitaliate-light to-digitaliate text-white font-bold text-xs px-3 py-1 rounded-full border border-digitaliate/20 shadow-sm">
                            Score: {lead.score}
                        </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <AppointmentsPanel 
                        leadId={lead.id} 
                        leadName={lead.name} 
                        calendlyUrl={settings?.calendly_url || 'https://calendly.com/'} 
                    />
